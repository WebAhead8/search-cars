...
function router(req, res) {
  ...
  if (url === "/") homeHandler(req, res);
  else if (url.includes("public")) publicHandler(req, res);
  else if (url.includes("search")) searchHandler(req, res);
  else if (url.includes("btata")) searchEmployeHandler(req, res);
